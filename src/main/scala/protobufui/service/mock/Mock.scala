...
class Mock[Req <: MessageLite : ClassTag, Res <: MessageLite : ClassTag](mockDefinition: MockDefinition[Req, Res]) extends Actor with ActorLogging {
  ...
  override def receive: Receive = {
    ...
    case Parsed(msg, connection) => responder ! Respond(msg, connection)
  }
